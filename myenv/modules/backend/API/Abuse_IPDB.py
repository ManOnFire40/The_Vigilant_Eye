...
def get_ip_info_ipdb(ip_address):
    try:
...
def get_ips_info_ipdb(ip_addresses):
    try:
        # takes a list of ip addresses and returns a list of reports
        list_of_ip_addresses_reports = []
        for ip_address in ip_addresses:
            list_of_ip_addresses_reports.append(get_ip_info_ipdb(ip_address, IPDB_API))
...
def get_subnet_info_ipdb(subnet):
    try:
        # Defining the api-endpoint
